...
<head>
   ...
   <title>Praktikum 3 OOP</title>
</head>

<body>
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="#">Berat Badan Ideal</a>
      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
         <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll" style="max-height: 100px;">
            <li class="nav-item">
               <a class="nav-link" href="data_bmi.php">Data <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
               <a class="nav-link" href="form_bmi.php">Form</a>
            </li>
      </div>
   </nav>
   <div class="container">
            ...
            <blockquote class="blockquote mb-0">
               <form method="POST" action="nilai_siswa.php">
                  ...
                  <div class="form-group row col-auto">
                     ...
                     <div class="input-group col-sm-5 my-1">
                        <div class="form-check">
                           <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option1" checked>
                           <label class="form-check-label ml-auto" for="gridRadios1">
                              Laki-Laki
                           </label>
                        </div>
                        <div class="form-check">
                           <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="option2">
                           <label class="form-check-label ml-auto" for="gridRadios2">
                              Perempuan
                           </label>
                        </div>
                     </div>
